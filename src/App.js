...
const tld = '.zingo';
const CONTRACT_ADDRESS = '0x8b03237086793A6D55512c31dDBaA8f90ee67AFa'; //'0xdB0A0969e10F8B7FD071B20E5566cBDf2AC8F4Da';
...
const App = () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/te5dtyqPvoNqOlNMhQ/giphy.gif" alt="Zzzingo gif" />
		...
		<div className="App">
			<div className="container">
				...
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">💤 Zingo Name Service</p>
